        ...
        {isOpen && (
          ...
          >
            ...
            <div className="px-4 pb-10 space-y-5 pt-3">
              ...
              {/* Footer */}
              <div className="h-px w-full" style={{ background: isDark ? "rgba(212,175,55,0.1)" : "rgba(204,122,0,0.2)" }} />
              <p
                className="text-center text-[10px] tracking-widest cursor-pointer transition-opacity hover:opacity-80"
                style={{ color: isDark ? "rgba(212,175,55,0.5)" : "#000000", fontFamily: "'DM Sans', sans-serif" }}
